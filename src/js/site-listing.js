 ...
 * @type {Element}
 */
var link = document.querySelector('link[href="src/partials/site-listing.html"]');
var content = link.import;
var el = content.querySelector('script');
document.querySelector('body').appendChild(el.cloneNode(true));


Vue.component('site-listing', {
...
/**
 * Creates the list of site records based on the environment. Everytime the environment
